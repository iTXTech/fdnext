...
- MX30LF1G18AC 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8458/MX30LF1G18AC%2C%203V%2C%201Gb%2C%20v1.2.pdf>
- MX30LF2G18AC / MX30LF4G18AC 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8461/MX30LF2G18AC%2C%203V%2C%202Gb%2C%20v1.4.pdf>
- MX60LF8G18AC 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8473/MX60LF8G18AC%2C%203V%2C%208Gb%2C%20v1.1.pdf>
- MX30LF1G28AD / MX30LF2G28AD / MX30LF4G28AD 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8864/MX30LF4G28AD%2C%203V%2C%204Gb%2C%20v1.3.pdf>
...
- MX30UF1G28AD / MX30UF2G28AD / MX30UF4G28AD 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8859/MX30UF1G28AD%2C%201.8V%2C%201Gb%2C%20v1.2.pdf>
- MX60UF8G28AD 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8862/MX60UF8G28AD%2C%201.8V%2C%208Gb%2C%20v1.2.pdf>
- MX30UF1G16/18AC、MX30UF2G16/18AC、MX30UF4G16/18AC 与 MX60UF8G18AC 数据手册：
...
- MX30UF4G28AC 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8476/MX30UF4G28AC%2C%201.8V%2C%204Gb%2C%20v1.0.pdf>
- MX30UF4G16/18AB 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8453/MX30UF4G18AB%2C%201.8V%2C%204Gb%2C%20v1.2.pdf>
- MX30LF1/2/4GE8AB 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8449/MX30LF1GE8AB%2C%203V%2C%201Gb%2C%20v1.3.pdf>
- MX30LF1208AA / MX30LF1G08AA 官方迁移 / 比较说明：
...
- MX30LF1G28AC 数据手册：<https://www.mxic.com.tw/Lists/Datasheet/Attachments/8463/MX30LF1G28AC%2C%203V%2C%201Gb%2C%20v1.1.pdf>
- MX30LF2G28AB / MX30LF4G28AB 官方迁移说明：<https://www.macronix.com/Lists/ApplicationNote/Attachments/1923/AN-0306V3-MGRT_MX30LF2G%284G%2928AB_to_MX30LF2G%284G%2918AC.pdf>
- MX60LF8G28AB 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8464/MX60LF8G28AB%2C%203V%2C%208Gb%2C%20v1.1.pdf>
- MX30UF2G26/28AB / MX30UF4G26/28AB Macronix PM2031 数据手册镜像：<https://media.digikey.com/pdf/Data%20Sheets/Macronix/MX30UFxG26%2828%29AB.pdf>
- MX30UF2GE8AB / MX30UF4GE8AB 数据手册：<https://www.macronix.com/Lists/Datasheet/Attachments/8454/MX30UF2GE8AB%2C%201.8V%2C%202Gb%2C%20v1.1.pdf>
- Macronix 官方 NAND 产品命名指南：<https://www.macronix.com/en-us/products/Documents/Macronix%2520NOR%2520and%2520NAND%2520Flash%2520Cross%2520Reference%2520Guide.pdf>
- Macronix 官方并行 SLC NAND 产品清单：<https://www.macronix.com/en-us/products/NAND-Flash/SLC-NAND-Flash/Pages/default.aspx>
...
规则只命中下表由官方资料确认的完整字节规格；其他 `C2` ID 保持原有厂商识别，不借用几何参数。

PN 解码器按官方订购编码语法拆分 `30/60` 类型、`L/U` 电压、容量、ECC、总线位宽、模式、代际与可选封装 / 温度后缀。基础 PN 不含封装编码段时不输出封装；代际技术编码与保留编码段只用于结构识别，不公开编码字段，也不写完整 PN 白名单。

## 已确认 Read ID

| Read ID | 产品 | 容量 / die / 平面 | 页 / 块 / 备用区 | ECC |
| --- | --- | --- | --- | --- |
...
这些型号均为 2.7V~3.6V、x8、SLC。18AC 与 28AD 的扩展 ID 字节定义不同，尤其 28AD 的 1/2Gbit 与 4/8Gbit 几何参数不同，因此测试逐条覆盖，不用一个统一几何参数回填。

## 1.8V UF 与内部-ECC 规格

| Read ID | 产品 | 容量 / 位宽 | 页 / 块 / 备用区 | ECC |
| --- | --- | --- | --- | --- |
...
| `C2 AA 90 15 86` | MX30UF2GE8AB | 2Gbit / x8 | 2KB / 128KB / 64B | 内部 4bit ECC/524B |
| `C2 AC 90 15 D6` | MX30UF4GE8AB | 4Gbit / x8 | 2KB / 128KB / 64B | 内部 4bit ECC/524B |

`MX30LF1/2/4GE8AB` 的 `C2 F1 80 95 82`、`C2 DA 90 95 86`、`C2 DC 90 95 D6` 均为 3V x8 SLC、2KB 页、128KB 块、64B 备用区，并由 ID 与数据手册确认内部 4-位 ECC。

## 并行 SLC 系列审计边界

- 已覆盖：官方产品清单中的 LF 08AA、18AC、28AB/28AC/28AD、LF GE8AB、UF 28AB/28AD、UF 16/18AC、UF 4G28AC、UF GE8AB，以及官方公开且 ID 相同的 UF 4G16/18AB。
- 4-字节 `08AA` ID 不含平面字节，因此不根据同族器件猜测 `plane_count`。
- 安全 `LFxxS` 等未取得精确 Read ID + 几何参数的型号继续保持仅厂商回退；PN 解码器仅按其公开编码段输出可确定字段，不反推 Flash ID 几何参数。
- 本文档和标识符规则包不包含任何 MX25、MX35 或其他 SPI NAND 系列。
