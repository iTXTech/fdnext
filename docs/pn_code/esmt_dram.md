...
本页记录 ESMT standalone DRAM 颗粒的 PN 结构。本轮覆盖官方产品页中可直接确认的 SDR、DDR、DDR2、DDR3/DDR3L、DDR4、LPDDR、LPDDR2、LPDDR3 与 LPDDR4X。2026-05-19 根据本轮用户提供的 datasheet 截图，将 ESMT `dram-pn.json` 条目从页眉里的括号式族内标记整理为订货表中的标准 Product ID 形式。

## 外部资料

- ESMT SDR SDRAM 产品页列出 `M12L*` / `M52S*` 系列 PN、容量组织、刷新、速度与 TSOP/BGA/VFBGA 封装。来源：<https://www.esmt.com.tw/en/Products/DRAM/SDRAM>；`M12L128168A-*TIG2S` / `*BIG2S` 与 `M52S32321A-*BIG` 的订货形式来自本轮截图。
...
- ESMT LPDDR / LPDDR2 / LPDDR3 / LPDDR4X 产品页列出 `M53D*`、`M54D*`、`M55D*`、`M56Z*` 系列的容量组织、电压、速度与 BGA 封装。来源：<https://www.esmt.com.tw/en/Products/DRAM/LPDDR2%20SDRAM>、<https://www.esmt.com.tw/en/Products/DRAM/LPDDR3%20SDRAM>、<https://www.esmt.com.tw/en/Products/DRAM/LPDDR4x%20SDRAM>；`M53D256328A-*BIG2F` 的订货形式来自本轮截图。
...
- 订货后缀中的速度 token（如 `E`、`D`、`B`、`4`、`5`、`6`、`1.5`、`1.8`、`2.5`、`7.5`）命中时，公开 `dram_speed` 只输出该具体速度 / timing，不再输出 family 级范围速度。
- `M15F` / `M55D` 等系列存在两位速度 token，例如 `GH`、`EF`、`DE`、`GF`、`EE`、`CD`；同样只输出具体速度 / timing。
- suffix `2C/2G/2H/2S/2Z` 或 `TIG/BIG/TVG/BVG/BG/BBG/FBIG` 等只作为封装、温区、Pb-free 与速度补充，不作为识别 PN 主结构的必要条件。
- datasheet 页眉中的 `M15T1G1664A (2S)`、`M13S64164A (2Y)`、`M12L128168A (2S)`、`M55D4G16256A (2R)` 等是系列 / 页面标记；`packages/core/resources/dram-pn.json` 收录订货表中的 `M15T1G1664A-EFBIG2S`、`M13S64164A-4TVAG2Y`、`M12L128168A-5TIG2S`、`M55D4G16256A-GFBG2R` 等 Product ID，不收录括号式页眉标记。
