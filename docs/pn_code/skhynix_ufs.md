...
| UC310: `HN8` + density(2) + interface(1) + NAND info(1) + package type(1) + generation(1) + temp(1) + feature(1) + serial(3) + optional suffix | SK hynix 128-layer V6 UFS3.1 |
...
| UC310 density `T0/T1/T2` | 128GB / 256GB / 512GB；512Gb x2 / x4 / x8 |
...
| NAND info `B` + generation `G` | UC310 V6 NAND information / generation |
