...
- 用户提供的 ISSI `IS43/46LQ32K01B` datasheet / ordering 截图确认 32Gb `(x16 x 2 channel)` LPDDR4/LPDDR4X、`32K01` = `1Gb x32`、`B` = Gen2、`-046/-053` = 4266/3733Mbps、200-ball BGA、I/A1/A2/A3 温度档。
