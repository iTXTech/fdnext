...
import type { LegacyFlashIdInfo, LegacyFlashInfo, LegacyLang, LegacyScalar, LegacyUnknown } from "./types";
...
function partExtraInfo(
  result: PartDecodeResult,
  fields: FieldValue[],
  map: Map<string, FieldValue>,
  lang: LegacyLang
): Record<string, LegacyScalar> {
...
export function toLegacyFlashInfo(
  result: PartDecodeResult,
  rawQuery: string,
  lang: LegacyLang,
...
function identifierExtraInfo(
  fields: FieldValue[],
  result: IdentifierDecodeResult,
  lang: LegacyLang
): Record<string, LegacyScalar> {
...
export function toLegacyFlashIdInfo(
  result: IdentifierDecodeResult,
  rawQuery: string,
  lang: LegacyLang,
  extraUrls: Record<string, string>
...
export function legacySearchPart(item: SearchResultItem, lang: LegacyLang): string {
...
export function toLegacySearchIdItem(
...
export function legacyInfo(engine: FdnextEngine): Record<string, unknown> {
...
export function partSummary(data: LegacyFlashInfo): string {
  return [
...
export function idSummary(data: LegacyFlashIdInfo): string {
  return [
