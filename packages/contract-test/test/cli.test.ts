...
const cliIdentifierSearch = runInProcess(["id", "search", "2C8464", "--lang", "eng", "--limit", "10", "--id-scheme", "nand.flash_id"]);
...
assert.equal(cliIdentifierSearch.operation, "identifier.search");
assert.equal((cliIdentifierSearch.input as { controllerGroup?: unknown } | undefined)?.controllerGroup, undefined);
